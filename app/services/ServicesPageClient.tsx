...
const services = [
  {
    ...
    points: [
      ...
      "Job Search Support & Resume Optimization",
      "Work Permit Application & Processing",
      "Credential Assessment & Skill Verification",
    ],
  },
  {
    id: "2",
        ...
        >
          <div className="flex flex-col md:flex-row items-center justify-center">
            ...
            <p className="font-sans tracking-widest uppercase text-sm text-end">
              Comprehensive consultation services tailored to make your migration journey smooth, successful, and stress-free.
            </p>
          </div>
          <m.div
            initial={{ opacity: 0 }}
                ...
                <Reveal key={service.id} delay={index * 0.1}>
                  <div className="group relative h-112.5 bg-white/5 border border-white/10 rounded-3xl p-8 flex flex-col justify-between hover:bg-white/10 transition-all duration-500 hover:-translate-y-2">
                    ...
                    <div>
                      ...
                      <p className="text-cream/60 text-sm leading-relaxed">{service.description}</p>
                    </div>
