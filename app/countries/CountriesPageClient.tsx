...
const AirplaneIcon = () => (
  <svg
    ...
    className="mr-3 shrink-0 text-ebony/60 group-hover:text-ebony transition-colors"
  >
...
const countries = [
  {
    ...
    title: "Australia",
    description:
      "A land of opportunity with a high standard of living, vibrant cities, and a robust economy seeking skilled professionals.",
    image: "/Australia.jpg",
    programs: [
    ...
    highlights: ["Excellent Weather", "High Wages", "World-Class Education"],
  },
  {
    id: "new-zealand",
    title: "New Zealand",
    description:
      "Famed for its stunning landscapes and high quality of life, New Zealand offers a safe, peaceful environment with great career prospects.",
    ...
    highlights: ["Beautiful Nature", "Safe Environment", "Quality Education", "Outdoor Lifestyle"],
  },
];
    ...
    <LazyMotion features={domAnimation}>
      <main className="min-h-screen">
        ...
        <section
          ...
          style={{
            backgroundImage:
              "linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.7)), url('/JRglobal-Countries.jpg')",
          }}
        >
          <div className="flex flex-col md:flex-row items-center justify-center">
            ...
            <p className=" font-sans tracking-widest uppercase text-sm text-end">
              Explore migration opportunities in the world&apos;s most desirable countries. We provide expert guidance for each destination.
            </p>
          </div>
          <m.div
            initial={{ opacity: 0 }}
              ...
              <Reveal key={country.id} delay={index * 0.2}>
                <div className={`flex flex-col md:flex-row gap-12 items-stretch ${index % 2 === 0 ? "" : "md:flex-row-reverse"}`}>
                  ...
                  <div className="w-full md:w-1/2 flex flex-col justify-center py-6">
                    ...
                    <p className="text-ebony/80 text-xl font-light mb-10 leading-relaxed max-w-xl">{country.description}</p>
                        ...
                        <ul className="space-y-3">
                          {country.programs.map((program, idx) => (
                            <li key={idx} className="flex items-start group">
                              <AirplaneIcon />
                              <span className="text-ebony/70 group-hover:text-ebony transition-colors text-sm font-medium">
                                {program}
                              </span>
                            </li>
                          ))}
                          ...
                          {country.highlights.map((highlight, idx) => (
                            <li key={idx} className="flex items-start group">
                              <svg
                                ...
                                stroke="currentColor"
                                strokeWidth="1.5"
                                className="mr-3 shrink-0 text-ebony/40 group-hover:text-ebony transition-colors"
                              >
